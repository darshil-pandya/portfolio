...
export const sideProjects = [
  {
    ...
    features: [
      ...
      { icon: '🚀', title: '0 to Shipped', desc: 'Designed, built, and run solo — live across a full IPL season with 7 active users' },
    ],
    stack: [
      ...
      { name: 'React Router v7', highlight: false },
      { name: 'GitHub Pages', highlight: false },
      { name: 'Firestore', highlight: false },
      { name: 'Python (data scripts)', highlight: false },
    ],
  },
]
